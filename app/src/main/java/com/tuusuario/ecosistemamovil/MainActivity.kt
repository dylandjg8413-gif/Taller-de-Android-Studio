...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        paradigmas.forEachIndexed { index, (nombre, tech, desc) ->
            Log.d(TAG, "Mostrando paradigma ${index+1}: $nombre")
            Log.w(TAG, "Advertencia simulada en $nombre")
            Log.e(TAG, "Error simulado en $nombre")
            layout.addView(createCard(nombre, tech, desc))
        }

        Log.i(TAG, "onCreate: UI construida con exito")
